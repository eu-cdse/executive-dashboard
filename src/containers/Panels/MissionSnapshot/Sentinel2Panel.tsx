...
const getMetrics = (missionSnapshot, dataPublished) => [
  ...
  missionSnapshot.find(({ id }) => id === 'product_timeliness_default_perc'),
  {
    ...
    label: 'Number of published products - Sentinel-2',
  ...
  },
  {
    ...
    label: 'Volume of published products - Sentinel-2',
    codelist_reduce: [product],
  },
  {
    ...deepClone(
...
const Sentinel2Panel = () => {
  ...
  return (
    <PanelWrapper>
      ...
      {cl.map((c) => (
        <div className="grid-item relative" key={'a0'}>
