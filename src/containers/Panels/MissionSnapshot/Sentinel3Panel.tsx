...
const getMetrics = (missionSnapshot, dataPublished) => [
  missionSnapshot.find(({ id }) => id === 'product_timeliness_perc'),
  {
    ...
    label: 'Number of published products - Sentinel-3',
  ...
  },
  {
    ...
    label: 'Volume of published products - Sentinel-3',
    codelist_reduce: [product],
  },
  {
    ...deepClone(
  ...
  [
    {
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_sral_nrt',
      label: 'Product timeliness - SRAL NRT',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_sral_stc',
      label: 'Product timeliness - SRAL STC',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_sral_ntc',
      label: 'Product timeliness - SRAL NTC',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_olci_nrt',
      label: 'Product timeliness - OLCI NRT',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_olci_ntc',
      label: 'Product timeliness - OLCI NTC',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_slstr_nrt',
      label: 'Product timeliness - SLSTR NRT',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_slstr_ntc',
      label: 'Product timeliness - SLSTR NTC',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_synergy_stc',
      label: 'Product timeliness - SYNERGY STC',
    },
    {
      ...deepClone(
        missionSnapshot.find(({ id }) => id === 'product_timeliness_bucket')
      ...
      codelist_reduce: ['S3'],
      productKey: 's3_synergy_ntc',
      label: 'Product timeliness - SYNERGY NTC',
    },
  ],
];

const Sentinel3Panel = () => {
